...
// 					// }
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other .el-menu .el-menu-item {
		...
		background: url(http://codegen.caihongy.cn/20240923/6f1cd0cde6ca44da8f6388cd5c25e3d3.png)  no-repeat  left top /  3% 100%,#fff !important;
		font-size: inherit !important;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other .el-menu .el-menu-item:hover {
		padding: 0 12px !important;
		color: #6DB344 !important;
		background: url(http://codegen.caihongy.cn/20240923/a95e2650bc1c4cf1b67ab0f94e42b050.png)  no-repeat  left top /  3% 100%,#fff !important;
		line-height: 30px !important;
		height: 30px !important;
	}
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home .el-menu .el-menu-item {
		...
		margin: 0 ;
		color: #636C70;
		background: url(http://codegen.caihongy.cn/20240923/6f1cd0cde6ca44da8f6388cd5c25e3d3.png)  no-repeat  left top /  3% 100%,#fff;
		font-size: inherit;
		line-height: 30px;
		transition: all 0s;
		height: 30px;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home .el-menu .el-menu-item:hover {
		padding: 0 12px;
		color: #6DB344;
		background: url(http://codegen.caihongy.cn/20240923/a95e2650bc1c4cf1b67ab0f94e42b050.png)  no-repeat  left top /  3% 100%,#fff;
		line-height: 30px;
		height: 30px;
	}
