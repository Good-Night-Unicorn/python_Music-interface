	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="发布人" prop="name" >
					<el-input v-model="ruleForm.name" placeholder="发布人" clearable  :readonly="ro.name"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="发布人" prop="name" >
			...
			<el-form-item v-else-if="ruleForm.introduction" label="简介" prop="introduction" >
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.content = this.ruleForm.content.replace(reg,'../../../djangomtj199wx/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
