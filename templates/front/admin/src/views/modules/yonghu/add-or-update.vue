	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="是否会员" prop="vip" >
				...
				<el-form-item v-else class="input" label="是否会员" prop="vip" >
					<el-input v-model="ruleForm.vip"
						placeholder="是否会员" readonly></el-input>
				</el-form-item>
			</template>
			<el-form-item class="textarea" v-if="type!='info'" label="个人简介" prop="gerenjianjie" >
				<el-input
			...
			<el-form-item v-else-if="ruleForm.gerenjianjie" label="个人简介" prop="gerenjianjie" >
				<span class="text">{{ruleForm.gerenjianjie}}</span>
			</el-form-item>
